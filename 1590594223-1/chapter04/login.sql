...
set trimspool on trimout on arrays 1 maxdata 9999 echo off head off timi off feedback off message off pause off autotrace off verify off time off termout off
